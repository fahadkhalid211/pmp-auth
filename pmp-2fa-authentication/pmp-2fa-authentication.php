 ...
 * 
 * Notice: This plugin is sold exclusively on CodeCanyon. Resale, redistribution, or 
 * sublicensing is strictly prohibited without a valid Extended License.
 *
...
register_deactivation_hook( __FILE__, 'pmp2fa_deactivate' );
function pmp2fa_deactivate() {
	// Clear any transients if needed.
	delete_transient( 'pmp2fa_rate_limit' );
}
